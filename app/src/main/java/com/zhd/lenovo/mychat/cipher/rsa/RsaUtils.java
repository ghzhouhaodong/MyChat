package com.zhd.lenovo.mychat.cipher.rsa;
...
public class RsaUtils {
    ...
    public String encryptContent(Context context,String content) {
        ...
        String afterEncrypt = com.zhd.lenovo.mychat.cipher.rsa.Rsa.encryptByPublic(content);
    ...
    public String createRsaSecret(Context context,String random){
        ...
        String afterEncrypt = com.zhd.lenovo.mychat.cipher.rsa.Rsa.encryptByPublic(String.valueOf(random));
